...
Our analysis uses play-by-play data from the 2024 NFL season sourced from NFLsavant.com, a publicly accessible resource containing detailed information for every offensive snap. The dataset includes 45 variables. The relavent variables are:
